...
- Also there are several additional screens – the **Stock screen** (shows current amount of each resource) and **the Upkeep screen** (shows total upkeep for all enabled structures).
